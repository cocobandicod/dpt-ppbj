                                ...
                                <form id="form">
                                    ...
                                    if (is_array($apiData)) {
                                        foreach ($apiData as $row) {
                                            if ($row['Kode Tender'] == $kode_tender) {
                                                $selectedData = $row;
                                    ...
                                    <input type="hidden" name="jenis_pengadaan" value="<?= @$selectedData['Kategori Pekerjaan']; ?>">
                                    <input type="hidden" name="metode_pengadaan" value="<?= @$selectedData['Metode Pemilihan']; ?>">
                                    <input type="hidden" name="metode_evaluasi" value="<?= @$selectedData['Metode Pengadaan'] . ' ' . @$selectedData['Metode Evaluasi']; ?>">
                                    <table class="table table-bordered fs-13">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $selectedData['Metode Pemilihan'] ?? 'Data tidak ditemukan'; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Metode Pengadaan</td>
                                            <td><?= $selectedData['Metode Pengadaan'] ?? 'Data tidak ditemukan'; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Metode Evaluasi</td>
                                            <td><?= $selectedData['Metode Evaluasi']; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Anggaran</td>
                                            <td>
