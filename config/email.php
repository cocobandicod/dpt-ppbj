    ...
    <tr align="center">
      <td>
        ...
        <table
          ...
          cellspacing="0"
          cellpadding="0"
          style="padding-bottom: 20px; max-width:100%; min-width: 220px">
          <tbody>
            <tr>
                <td width="8" style="width: 8px"></td>
                <td>
...
function template_ukpbj($isi, $email, $file, $url)
{
  if (empty($file)) {
    $download = '';
  } else {
    ...
    <a href="' . $url . 'berkas/' . $file . '"
    style="font-family:Google Sans,Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px"
    target="_blank">Download File</a></div>
    ';
  }
  $template = '
 <table
                  ...
                  <div
                    ...
                    <div
                      style="
                        ...
                        word-break: break-word;
                      ">
                      <div style="font-size: 18px">Nota Dinas PPK</div>
                      <table align="center" style="margin-top: 8px">
                        <tbody>
                          <tr style="line-height: normal">
                            <td>
...
function template_pokja($isi, $email, $file, $url)
{
  if (empty($file)) {
    $download = '';
  } else {
                  ...
                  <div
                    ...
                    <div
                      style="
                        ...
                        word-break: break-word;
                      ">
                      <div style="font-size: 18px">Nota Dinas Kepala UKPBJ</div>
                      <table align="center" style="margin-top: 8px">
                        <tbody>
                          <tr style="line-height: normal">
                            <td>
...
function template_verifikasi($email, $nama)
{
  $template = '
 <table
  width="100%"
                  ...
                  <div
                    ...
                    <div
                      style="
                        ...
                        word-break: break-word;
                      ">
                      <div style="font-size: 18px">STATUS VERIFIKASI</div>
                      <table align="center" style="margin-top: 8px">
                        <tbody>
                          <tr style="line-height: normal">
                            <td>
                    ...
                    <div
                      ...
                      <h2>TERVERIFIKASI</h2>
                      <h3>' . $nama . '</h3>
                      Selamat! status anda terverifikasi, anda dapat mengikuti prosedur pengelola pengadaan barang dan jasa<br>di lingkungan Universitas Negeri Gorontalo
                    </div>
                  </div>
                  <div style="text-align: left">
                    <div
