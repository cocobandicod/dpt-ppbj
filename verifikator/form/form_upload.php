                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="ps-2 pe-2 text-center"><a href="#" id="del" data-id="<?= @$row['id']; ?>" data-nama="<?= @$row['nama_file']; ?>" data-act="delfile"><i class="ri-delete-bin-fill align-bottom text-danger fs-15"></i></a></td>
                            </tr>
                        <?php $no++;
                        } ?>
                    </tbody>
    ...
    <div class="modal-body pt-3">
        <table class="table table-bordered table-sm fs-13">
            <tbody>
                ...
                <tr>
                    <td class="ps-2 pe-2">Lokasi Pekerjaan</td>
                    <td class="ps-2 pe-2"><?= $s['lokasi_pekerjaan']; ?></td>
                </tr>
                <tr>
                    <td class="ps-2 pe-2">Sumber Dana</td>
                    <td class="ps-2 pe-2"><?= $s['sumber_dana']; ?></td>
                </tr>
                <tr>
                    <td class="ps-2 pe-2">Tahun Anggaran</td>
                    <td class="ps-2 pe-2"><?= $s['tahun_anggaran']; ?></td>
                </tr>
            </tbody>
        </table>
        <table id="example" class="table table-bordered table-sm mb-0 fs-13">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="ps-2 pe-2"><?= $row['nama']; ?></td>
                        <td class="ps-2 pe-2"><?= $row['email']; ?></td>
                        <td class="ps-2 pe-2"><?= $row['alamat']; ?></td>
                        <td class="ps-2 pe-2"><?= $row['jabatan']; ?></td>
                        <td class="text-center ps-2 pe-2"><a href="#" id="terapkan" data-id="<?= $s['kode_paket']; ?>" data-operator="<?= $row['id_operator']; ?>" data-nama="<?= $row['nama']; ?>"><span class="badge bg-success-subtle text-success fs-13">Pilih</span></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
...
?>
    ...
    <form id="kirim_email" enctype="multipart/form-data">
            ...
            ?>
                ...
                <table class="table table-bordered table-sm fs-13">
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-2 pe-2">Nilai PAGU</td>
                            <td class="ps-2 pe-2">Rp. <?= number_format(@$s['nilai_pagu']); ?></td>
                        </tr>
                        <tr>
                            <td class="ps-2 pe-2">Nilai HPS</td>
                            <td class="ps-2 pe-2">Rp. <?= number_format(@$s['nilai_hps']); ?></td>
                        </tr>
                        <tr>
                            <td class="ps-2 pe-2">Nota Dinas</td>
                            <td class="ps-2 pe-2">
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-light fw-medium" data-bs-dismiss="modal">Batal</a>
            <button class="btn btn-success simpan" style="display:<?= $display; ?>;" type="submit"><i class="ri-mail-send-line"></i> Kirim</button>
        </div>
    </form>
    <script>
        function validasiFile() {
