    ...
    $subdata[] = '
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a href="' . $url . 'verifikator/penyedia/dokumen/' . $row['id_profil'] . '" class="dropdown-item edit-item-btn"><i class="ri-search-2-line align-bottom me-2 text-muted"></i> Dokumen</a></li>
                        <li><a href="' . $url . 'verifikator/penyedia/edit/' . $row['id_profil'] . '" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        <li><a href="' . $url . 'verifikator/penyedia/detail/' . $row['id_profil'] . '" class="dropdown-item edit-item-btn"><i class="ri-send-plane-fill align-bottom me-2 text-muted"></i> Proses</a></li>
                    </ul>
                 </div>
    ';
    $data[] = $subdata;
