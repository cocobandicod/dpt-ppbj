                    ...
                    <div class="col-xl-12">
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <a href="<?= $url; ?>ukpbj/pegawai/add" class="btn btn-primary btn-sm"><i class="ri-add-line align-bottom me-1"></i> Data</a>
                            </div><!-- end card header -->
                            <!-- card body -->
                            <div class="card-body">
