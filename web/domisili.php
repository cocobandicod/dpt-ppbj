                                        ...
                                        <div class="card">
                                            <div class="card-body p-0">
                                                <div class="row align-items-end">
                                                    <div class="col-sm-12">
                                                        <div class="p-3">
                                                            <a href="<?= $url; ?>syarat-domisili/add" class="btn btn-primary btn-sm mb-3"><i class="ri-add-line align-bottom me-1"></i> Data</a>
