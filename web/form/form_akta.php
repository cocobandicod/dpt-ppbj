...
cek_url($url, $proses, $_GET['act'], 'akta', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <form id="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'akta', 'id = "' . $_GET['id'] . '"');
                                    ...
                                    <div class="row pt-2">
                                        <div class="col-xxl-4 col-md-4 pt-2">
                                            <label for="basiInput" class="form-label">Jenis *</label>
                                            <?= akta('jenis', @$row['jenis']); ?>
                                        </div>
                                        <div class="col-xxl-4 col-md-4 pt-2">
                                        ...
                                        <div class="col-xxl-4 col-md-4 pt-2">
                                            <label for="basiInput" class="form-label">Tanggal Dikeluarkan *</label>
                                            <input type="date" class="form-control" name="tanggal" value="<?= @$row['tanggal']; ?>" required>
                                        </div>

                                        <div class="col-xxl-4 col-md-4 pt-2">
                                            <label for="basiInput" class="form-label">Nama Notaris *</label>
                                            <input type="text" class="form-control" name="nama_notaris" value="<?= @$row['nama_notaris']; ?>" required>
                                        </div>
