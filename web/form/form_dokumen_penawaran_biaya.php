...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
                                    ...
                                    <div class="card-body small">
                                        <div id="revdiv">
                                            <form id="form" enctype="multipart/form-data">
                                                <?php
                                                $row = $proses->tampil_data_saja('*', 'dokumen_penawaran_biaya', 'id_profil = "' . $_SESSION['kode_profil'] . '"');
                                                ?>
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <?php
                                                        if (!@$row['file_penawaran_biaya']) {
                                                            $a = 0;
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Surat Penawaran Biaya</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <label for="basiInput" class="form-label">Upload Surat Penawaran Biaya*</label>
                                                                </div>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <input type="file" name="fupload1" onchange="validasiFile(this)" class="form-control file" required>
                                                                    <div id="passwordHelpBlock" class="form-text">
                                                                        *Accepted formats: pdf 2Mb
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } else {
                                                            $a = 1;
                                                            $act1 = pathinfo(@$row['file_penawaran_biaya'], PATHINFO_EXTENSION);
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Surat Penawaran Biaya</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                ...
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalview" data-act="<?= $act1; ?>" data-id="<?= $row['file_penawaran_biaya']; ?>"><i class="ri-search-line"></i> Lihat File</button>
                                                                    <button type="button" id="del" data-id="file_penawaran_biaya" data-nama="File Surat Penawaran Biaya" data-act="del" class="text-danger btn btn-sm btn-light"><i class="ri-delete-bin-line"></i> File</button>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <?php
                                                        if (!@$row['file_rekapitulasi']) {
                                                            $b = 0;
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Rekapitulasi Penawaran Biaya</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <label for="basiInput" class="form-label">Upload Rekapitulasi Penawaran Biaya</label>
                                                                </div>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <input type="file" name="fupload2" onchange="validasiFile(this)" class="form-control file" required>
                                                                    <div id="passwordHelpBlock" class="form-text">
                                                                        *Accepted formats: pdf 2Mb
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <?php } else {
                                                            $b = 1;
                                                            $act2 = pathinfo(@$row['file_rekapitulasi'], PATHINFO_EXTENSION);
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Rekapitulasi Penawaran Biaya</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    Upload Surat Rekapitulasi Penawaran Biaya
                                                                </div>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalview" data-act="<?= $act2; ?>" data-id="<?= $row['file_rekapitulasi']; ?>"><i class="ri-search-line"></i> Lihat File</button>
                                                                    <button type="button" id="del" data-id="file_rekapitulasi" data-nama="File Rekapitulasi Penawaran Biaya" data-act="del" class="text-danger btn btn-sm btn-light"><i class="ri-delete-bin-line"></i> File</button>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <?php
                                                        if (!@$row['file_rincian_komponen']) {
                                                            $c = 0;
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Rincian Komponen Remunerasi Personel</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <label for="basiInput" class="form-label">Upload Rincian Komponen Remunerasi Personel</label>
                                                                </div>
                                                                <div class="col-xxl-6 col-md-6">
                                                        ...
                                                        <?php } else {
                                                            $c = 1;
                                                            $act3 = pathinfo(@$row['file_rincian_komponen'], PATHINFO_EXTENSION);
                                                        ?>
                                                            <div class="row pt-3">
                                                                <h6>Rincian Komponen Remunerasi Personel</h6>
                                                                <div class="col-xxl-6 col-md-6">
                                                                ...
                                                                <div class="col-xxl-6 col-md-6">
                                                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalview" data-act="<?= $act3; ?>" data-id="<?= $row['file_rincian_komponen']; ?>"><i class="ri-search-line"></i> Lihat File</button>
                                                                    <button type="button" id="del" data-id="file_rincian_komponen" data-nama="File Rincian Komponen Remunerasi Personel" data-act="del" class="text-danger btn btn-sm btn-light"><i class="ri-delete-bin-line"></i> File</button>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
    ...
    <script>
        ...
        $(document).on('submit', '#form', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= $url; ?>proses/dokumen/penawaran/biaya',
