...
cek_url($url, $proses, $_GET['act'], 'peralatan', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="p-3">
                                                            <form id="form" enctype="multipart/form-data">
                                                                <?php
                                                                if ($_GET['act'] == 'edit') {
                                                                    $row = $proses->tampil_data_saja('*', 'peralatan', 'id = "' . $_GET['id'] . '"');
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-xxl-4 col-md-4 pt-2">
                                                                        <label for="basiInput" class="form-label">Jenis Peralatan *</label>
                                                                        <input type="text" class="form-control" name="jenis_peralatan" value="<?= @$row['jenis_peralatan']; ?>" required>
                                                                    </div>
                                                                    <div class="col-xxl-4 col-md-4 pt-2">
                                                                        <label for="basiInput" class="form-label">Jumlah *</label>
                                                                        <input type="text" class="form-control" name="jumlah" value="<?= @$row['jumlah']; ?>" required>
                                                                    </div>
                                                                    <div class="col-xxl-4 col-md-4 pt-2">
                                                                        <label for="basiInput" class="form-label">Kapasitas *</label>
                                                                        <input type="text" class="form-control" name="kapasitas" value="<?= @$row['kapasitas']; ?>" required>
                                                                    </div>
                                                                    <div class="col-xxl-4 col-md-4 pt-2">
                                                                        <label for="basiInput" class="form-label">Merek Type *</label>
                                                                        <input type="text" class="form-control" name="merek" value="<?= @$row['merek']; ?>" required>
                                                                    </div>
                                                                    <div class="col-xxl-2 col-md-2 pt-2">
                                                                        <label for="basiInput" class="form-label">Tahun *</label>
                                                                        <input type="text" class="form-control" name="tahun" value="<?= @$row['tahun']; ?>" required>
                                                                    </div>
                                                                    <div class="col-xxl-2 col-md-2 pt-2">
                                                                        <label for="basiInput" class="form-label">Kondisi (%) *</label>
