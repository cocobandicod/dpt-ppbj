...
cek_url($url, $proses, $_GET['act'], 'pajak', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body small">
                                        <form id="form" enctype="multipart/form-data">
                                            <?php
                                            if ($_GET['act'] == 'edit') {
                                                $row = $proses->tampil_data_saja('*', 'pajak', 'id = "' . $_GET['id'] . '"');
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-xl-6">
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                        <label for="basiInput" class="form-label">Jenis Laporan *</label>
                                                        <?= pajak('jenis_laporan', @$row['jenis_laporan']); ?>
                                                    </div>
                                                    <div class="col-xxl-12 col-md-12 pt-2">
