...
cek_url($url, $proses, $_GET['act'], 'pemilik_saham', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <form id="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'pemilik_saham', 'id = "' . $_GET['id'] . '"');
                                    ...
                                    <div class="row pt-2">
                                        <div class="col-xxl-4 col-md-4 pt-2">
                                            <label for="basiInput" class="form-label">Nomor KTP *</label>
                                            <input type="text" class="form-control" name="nomor_ktp" value="<?= @$row['nomor_ktp']; ?>" required>
                                        </div>
                                        <div class="col-xxl-4 col-md-4 pt-2">
                                        ...
                                        <div class="col-xxl-2 col-md-2 pt-2">
                                            <label for="basiInput" class="form-label">Persen Saham *</label>
                                            <input type="text" class="form-control" name="persen_saham" value="<?= @$row['persen_saham']; ?>" required>
                                        </div>
                                        <div class="col-xxl-2 col-md-2 pt-2">
                                            <label for="basiInput" class="form-label">Tipe Saham *</label>
                                            <?= saham('tipe_saham', @$row['tipe_saham']); ?>
                                        </div>
                                        <div class="col-xxl-4 col-md-4 pt-2">
