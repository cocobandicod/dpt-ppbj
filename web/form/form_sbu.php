...
cek_url($url, $proses, $_GET['act'], 'sbu', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body small">
                                        <form id="form" enctype="multipart/form-data">
                                            <?php
                                            if ($_GET['act'] == 'edit') {
                                                $row = $proses->tampil_data_saja('*', 'sbu', 'id = "' . $_GET['id'] . '"');
                                            ...
                                            <div class="row pt-2">
                                                ...
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Jenis Izin *</label>
                                                    <?= izin_usaha('jenis_izin', 'Sertifikat-Badan-Usaha-(SBU)'); ?>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Nomor Registrasi *</label>
                                                    <input type="text" class="form-control" name="no_registrasi" value="<?= @$row['no_registrasi']; ?>" required>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Nama Badan Usaha *</label>
                                                    <input type="text" class="form-control" name="nama_badan_usaha" value="<?= @$row['nama_badan_usaha']; ?>" required>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Nama Pimpinan PJBU *</label>
                                                    <input type="text" class="form-control" name="nama_pimpinan" value="<?= @$row['nama_pimpinan']; ?>" required>
                                                </div>
                                                <div class="col-xxl-12 col-md-12 pt-2">
                                                    <label for="basiInput" class="form-label">Alamat Badan Usaha *</label>
                                                    <input type="text" class="form-control" name="alamat_badan" value="<?= @$row['alamat_badan']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">Kabupaten / Kota *</label>
                                                    <input type="text" class="form-control" name="kab_kota" value="<?= @$row['kab_kota']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">Provinsi *</label>
                                                    <input type="text" class="form-control" name="provinsi" value="<?= @$row['provinsi']; ?>" required>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                ...
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    ...
                                                    <input type="text" class="form-control" name="kode_pos" value="<?= @$row['kode_pos']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">Nomor Telepon *</label>
                                                    <input type="text" class="form-control" name="no_telepon" value="<?= @$row['no_telepon']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">Nomor Fax *</label>
                                                    <input type="text" class="form-control" name="no_fax" value="<?= @$row['no_fax']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">NPWP *</label>
                                                    <input type="text" class="form-control" name="npwp" value="<?= @$row['npwp']; ?>" required>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Jenis Usaha *</label>
                                                    <input type="text" class="form-control" name="jenis_usaha" value="<?= @$row['jenis_usaha']; ?>" required>
                                                </div>
                                                <div class="col-xxl-6 col-md-6 pt-2">
                                                    <label for="basiInput" class="form-label">Sifat Usaha *</label>
                                                    <input type="text" class="form-control" name="sifat_usaha" value="<?= @$row['sifat_usaha']; ?>" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
                                                    <label for="basiInput" class="form-label">Kekayaan Bersih *</label>
                                                    <input type="text" class="form-control" name="kekayaan_bersih" value="<?= @$row['kekayaan_bersih']; ?>" placeholder="Rp. 1.000.000" required>
                                                </div>
                                                <div class="col-xxl-3 col-md-3 pt-2">
