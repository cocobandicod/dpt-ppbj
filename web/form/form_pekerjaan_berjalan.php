...
cek_url($url, $proses, $_GET['act'], 'pekerjaan_berjalan', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <form id="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'pekerjaan_berjalan', 'id = "' . $_GET['id'] . '"');
                                    ...
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-xxl-3 col-md-3 pt-2">
                                            <label for="basiInput" class="form-label">File Pendukung *</label>
                                            <?php
                                            if (!empty($row['file'])) {
        ...
        $(document).on('click', '#del', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'post',
                        url: '<?= $url; ?>proses/pekerjaan/berjalan',
                        data: {
                            del: del,
                            act: act
                        },
