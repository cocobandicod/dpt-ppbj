                                        ...
                                        <form id="form" enctype="multipart/form-data">
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-xl-6 pb-4">
                                                    ...
                                                    <h5 class="pt-4">Pemberi Tugas</h5>
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                        ...
                                                        <input type="text" class="form-control" name="no_kontrak" value="<?= @$row['no_kontrak']; ?>" required>
                                                    </div>
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                    ...
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                        ...
                                                        <input type="text" class="form-control" name="nilai_kontrak" value="<?= @$row['nilai_kontrak']; ?>" required>
                                                    </div>
                                                    <div class="col-xxl-12 col-md-12 pt-2">
