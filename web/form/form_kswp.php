...
cek_url($url, $proses, $_GET['act'], 'kswp', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                ...
                                <form id="form" enctype="multipart/form-data">
                                    ...
                                    <div class="row pt-2">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="col-xxl-12 col-md-12 pt-2">
                                                <label for="basiInput" class="form-label">Upload Screenshot KSWP *</label>
                                                <?php
                                                if (!empty($row['file'])) {
                                                ...
                                                <div id="passwordHelpBlock" class="form-text">
                                                    *Hasil Tangkapan Layar (Screenshot) KSWP<br>
