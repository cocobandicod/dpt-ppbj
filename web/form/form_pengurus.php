...
cek_url($url, $proses, $_GET['act'], 'pengurus', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body small">
                                        <form id="form" enctype="multipart/form-data">
                                            <?php
                                            if ($_GET['act'] == 'edit') {
                                                $row = $proses->tampil_data_saja('*', 'pengurus', 'id = "' . $_GET['id'] . '"');
