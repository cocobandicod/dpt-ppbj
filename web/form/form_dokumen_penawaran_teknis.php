...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body small">
                                        <form id="form" enctype="multipart/form-data">
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-xl-6">
                                                    <h6>Dokumen Penawaran Teknis</h6>
                                                    <ol type="1">
                                                        <li>Company Profile/CV</li>
                                                        <li>Data Pengalaman Kerja Sejenis 10 (Sepuluh) Tahun Terakhir</li>
                                                        <li>Data Pengalaman Kerja di Provinsi Lokasi Kegiatan 10 (Sepuluh) Tahun Terakhir</li>
                                                        <li>Uraian Pengalaman Kerja Sejenis atau Pengalaman Kerja di Provinsi Lokasi Kegiatan 10 (Sepuluh) Tahun Terakhir </li>
                                                        <li>Jadwal Waktu Pelaksanaan Pekerjaan</li>
                                                        <li>Komposisi Tim dan Penugasan</li>
                                                        <li>Jadwal Penugasan Tenaga Ahli</li>
                                                        <li>Daftar Riwayat Hidup Personel Yang Diusulkan</li>
                                                        <li>Surat Pernyataan Kesediaan Untuk Ditugaskan</li>
                                                    </ol>
                                                    <div class="alert  alert-danger" role="alert">
                                                        Semua Dokumen yang disebutkan diatas masing-masing dalam bentuk .pdf disimpan dalam satu berkas dokumen.zip atau dokumen.rar yang kurang dari 20Mb
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="col-xxl-12 col-md-12">
                                                        ...
                                                        <div id="passwordHelpBlock" class="form-text">
                                                            *Accepted formats: zip, rar. Max file size 20Mb
                                                            <?= $text; ?>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).on('submit', '#form', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= $url; ?>proses/dokumen/penawaran/teknis',
        ...
        function validasiFile() {
            ...
            if (!ekstensiOk.exec(pathFile)) {
                alert('Silakan upload file yang memiliki ekstensi .zip/.rar');
                inputFile.value = '';
                return false;
            } else {
                if (file_size > 20000000) {
                    alert('Ukuran file harus kurang dari 20Mb');
                    inputFile.value = '';
                    return false;
                }
            }
