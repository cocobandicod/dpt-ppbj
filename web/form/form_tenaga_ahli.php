...
cek_url($url, $proses, $_GET['act'], 'tenaga_ahli', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body small">
                                        <form id="form" enctype="multipart/form-data">
                                            <?php
                                            if ($_GET['act'] == 'edit') {
                                                $row = $proses->tampil_data_saja('*', 'tenaga_ahli', 'id = "' . $_GET['id'] . '"');
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6 pt-2">
                                                            <label for="basiInput" class="form-label">Pendidikan *</label>
                                                        ...
                                                        <div class="col-xxl-6 col-md-6 pt-2">
                                                            <label for="basiInput" class="form-label">Pengalaman (Tahun) *</label>
                                                            <input type="text" class="form-control" name="pengalaman" value="<?= @$row['pengalaman']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                        <label for="basiInput" class="form-label">Keahlian *</label>
                                                        <input type="text" class="form-control" name="keahlian" value="<?= @$row['keahlian']; ?>" required>
                                                    </div>
                                                    <div class="col-xxl-12 col-md-12 pt-2">
                                                        <label for="basiInput" class="form-label">Tahun Ijazah / Sertifikat *</label>
                                                        <input type="text" class="form-control" name="tahun_ijazah" value="<?= @$row['tahun_ijazah']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
