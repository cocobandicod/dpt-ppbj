...
cek_url($url, $proses, $_GET['act'], 'sertifikat', 'id_profil ="' . @$_SESSION['kode_profil'] . '" AND id ="' . @$_GET['id'] . '"');
?>
<!doctype html>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <form id="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'sertifikat', 'id = "' . $_GET['id'] . '"');
                                    ...
                                    <div class="row pt-2">
                                        <div class="col-xl-6">
                                            <div class="col-xxl-12 col-md-12 pt-2">
                                                <label for="basiInput" class="form-label">Nama Sertifikat *</label>
                                                <input type="text" id="cleave-delimiters" class="form-control" name="nama_sertifikat" value="<?= @$row['nama_sertifikat']; ?>" required>
                                            </div>
                                            <div class="col-xxl-12 col-md-12 pt-2">
