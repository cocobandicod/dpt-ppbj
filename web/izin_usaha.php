                            ...
                            <div class="col-lg-9 mt-3">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="<?= $url; ?>syarat/izin/usaha/add" class="btn btn-primary btn-sm"><i class="ri-add-line align-bottom me-1"></i> Data</a>
                                    </div><!-- end card header -->
                                    <div class="card-body small">
