                            ...
                            <div class="col-lg-9 mt-3">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="<?= $url; ?>dokumen/penawaran/teknis/add" class="btn btn-primary btn-sm"><i class="ri-add-line align-bottom me-1"></i> Data</a>
                                    </div><!-- end card header -->
                                    <div class="card-body small">
    ...
    <script>
        ...
        $(document).ready(function() {
            dataTable = $('#DTable').DataTable({
                ...
                "ajax": {
                    url: "<?= $url; ?>tabel/dokumen/penawaran/teknis",
                    type: "post"
                }
            });
        });
