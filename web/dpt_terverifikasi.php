                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-12 order-2 order-lg-1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <h2 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base text-white">DPT Terverifikasi</h2>
                        </div>
                    </div>
                </div>
            </div><!-- end container -->
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <table id="example" class="table table-bordered dt-responsive table-striped align-middle fs-13 table-sm" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = $proses->tampil_data_select('*', 'profil_badan_usaha', '1=1 AND status = "Terverifikasi" ORDER BY id_profil DESC');
                                        $no = 1;
                                        foreach ($sql as $row) {
                                        ?>
                                            <tr>
