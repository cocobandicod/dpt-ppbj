...
$sql = $proses->tampil_data_select('*', 'izin_usaha', 'id_profil ="' . $_SESSION['kode_profil'] . '" AND jenis_izin = "Nomor-Induk-Berusaha-(NIB)"');
    ...
    $subdata[] = '
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a href="' . $url . 'syarat/nib/edit/' . $row['id'] . '" data-id="' . $row['id'] . '" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        <li>
