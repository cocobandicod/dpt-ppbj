...
$sql = $proses->tampil_data_select('*', 'pekerjaan_berjalan', 'id_profil ="' . $_SESSION['kode_profil'] . '"');
...
foreach ($sql as $row) {
    ...
    $subdata[] = '
                <div class="dropdown d-inline-block">
                    ...
                    <li><a href="' . $url . 'syarat-pekerjaan-berjalan/edit/' . $row['id'] . '" data-id="' . $row['id'] . '" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        <li>
