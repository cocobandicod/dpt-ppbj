...
$sql = $proses->tampil_data_select('*', 'kswp', 'id_profil ="' . $_SESSION['kode_profil'] . '"');
    ...
    $subdata[] = '
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a href="' . $url . 'syarat/kswp/edit/' . $row['id'] . '" data-id="' . $row['id'] . '" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        <li>
                            <a href="#" id="del" data-id="' . $row['id'] . '" data-nama="' . $row['npwp'] . '" data-act="del" class="dropdown-item remove-item-btn">
