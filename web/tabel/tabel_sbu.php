...
$sql = $proses->tampil_data_select('*', 'sbu', 'id_profil ="' . $_SESSION['kode_profil'] . '"');
...
foreach ($sql as $row) {
    ...
    $subdata[] = $row['no_registrasi'];
    $subdata[] = $row['nama_badan_usaha'];
    ...
    $subdata[] = '
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a href="' . $url . 'syarat/sbu/edit/' . $row['id'] . '" data-id="' . $row['id'] . '" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                        <li>
