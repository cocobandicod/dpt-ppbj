...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
    ...
    <div class="layout-wrapper landing">
        ...
        <!-- start hero section -->
        <section class="section nft-hero" style="background-image: url(assets/images/bg-home.jpg); background-color: #000; opacity:.95; padding-top:300px; padding-bottom:250px;" id="home">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-sm-12">
                        <div class="text-center">
                            <h1 class="display-5 fw-medium mb-0 lh-base text-white">Daftar Penyedia Terpilih<br><span class="text-success">Pengelola Pengadaan Barang dan Jasa</span></h1>
                            <p class="lead text-white-50 lh-base mb-4 pb-2 pt-0 fs-1">Universitas Negeri Gorontalo</p>
                            ...
                            <div class="card-body">
                                <ul class="list-inline fs-14 text-muted mb-2">
                                    <li class="list-inline-item">
                                        <i class="ri-calendar-line align-bottom me-1"></i> 30 Oct, 2024
                                    </li>
                                    <li class="list-inline-item">
                                        <i class="ri-user-3-line align-bottom me-1"></i> Allan Amilie
                                    </li>
                                </ul>
                                <a href="#">
                                    <h5>Pengumuman Pengadaan Barang Pengadaan Meja dan Kursi Kuliah Fakultas Kedokteran Universitas Negeri Gorontalo Tahun 2024</h5>
                                </a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="#">
                                    <h5>Pengumuman Pengadaan Barang Pengadaan Alat Penunjang Pendidikan Tahun Anggaran 2024</h5>
                                </a>
                            </div>
                        </div>
                    </div>
