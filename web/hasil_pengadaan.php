                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-12 order-2 order-lg-1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <h2 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base text-white">Hasil Pengadaan</h2>
                        </div>
                    </div>
                </div>
            </div><!-- end container -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="p-2"><span class="cursor-pointer text-primary" data-bs-toggle="modal" data-bs-target="#DetailModal" data-id="<?= @$row['id_paket']; ?>" data-act="evaluasi"><?= $row['nama_pekerjaan']; ?></span></td>
                                            </tr>
                                        <?php $no++;
                                        } ?>
                                    </tbody>
