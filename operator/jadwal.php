...
<body>
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="card">
                            <div class="card-header d-flex align-items-center pt-3 pb-3">
                                ...
                                <div>
                                    <span class="btn btn-primary btn-label waves-effect waves-light btn-sm" data-bs-toggle="modal" data-bs-target="#DetailModal" data-id="<?= $_GET['id']; ?>" data-act="add"><i class="ri-add-circle-line label-icon align-middle fs-16 me-2"></i> Data</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
    ...
    <script>
        ...
        $(document).on('submit', '#form', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= $url ?>operator/proses/jadwal',
