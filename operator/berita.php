                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="card">
                            <div class="card-header d-flex align-items-center pt-3 pb-3">
                                ...
                                <div>
                                    <a href="<?= $url; ?>operator/news/update/add" class="btn btn-primary btn-label waves-effect waves-light btn-sm"><i class="ri-add-circle-line label-icon align-middle fs-16 me-2"></i> Data</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
        ...
        $(document).on('click', '#del', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'post',
                        url: '<?= $url; ?>operator/proses/berita',
                        data: {
                            del: del,
                            act: act
                        },
